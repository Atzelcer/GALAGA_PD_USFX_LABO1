#undef GALAGA_PD_USFX_LABO1_API
...
#define UE_PROJECT_NAME GALAGA_PD_USFX_LABO1
#define UE_TARGET_NAME GALAGA_PD_USFX_LABO1Editor
#define UE_MODULE_NAME "GALAGA_PD_USFX_LABO1"
...
#define GALAGA_PD_USFX_LABO1_API DLLEXPORT
