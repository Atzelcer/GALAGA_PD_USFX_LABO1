...
ASHIP_LEVEL_01::ASHIP_LEVEL_01()
{
	// Conguracion de este actor en cada fotograma del juego 
	PrimaryActorTick.bCanEverTick = true;

	//|*| COMPONENTE MALLA DE LA NAVE |*|
	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/ASSETS/NAVE_PROTAGONISTA/NAVE_PROTAGONISTA.NAVE_PROTAGONISTA'"));
	...
	//Asignando un nombre 
	Identificador_Nave = "Nave_Nivel_01";
}

void ASHIP_LEVEL_01::BeginPlay()
{
	Super::BeginPlay();
}

void ASHIP_LEVEL_01::Tick(float DeltaTime)
{
...
void ASHIP_LEVEL_01::Recibir_Danio()
{
	//|*| PARA HACER DANIO A LA NAVE  |*|
	Life -= Danio_Recibido;
}

void ASHIP_LEVEL_01::NotifyActorBeginOverlap(AActor* OtherActor)
{
...
void ASHIP_LEVEL_01::ComponentesUE_Sistema()
{
