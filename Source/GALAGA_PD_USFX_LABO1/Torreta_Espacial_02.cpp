...
ATorreta_Espacial_02::ATorreta_Espacial_02()
{
	PrimaryActorTick.bCanEverTick = true;

	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/ASSETS/TORRETAS/Mesh_Torretas/Torreta08/6a249381bbec_Space_Turret__3d_as.6a249381bbec_Space_Turret__3d_as'"));
...
void ATorreta_Espacial_02::BeginPlay()
{
	Super::BeginPlay();
}

void ATorreta_Espacial_02::Tick(float DeltaTime)
{
...
void ATorreta_Espacial_02::Disparar_Torreta() const
{
