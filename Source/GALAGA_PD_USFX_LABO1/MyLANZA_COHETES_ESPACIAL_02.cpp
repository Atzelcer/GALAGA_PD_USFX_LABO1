...
AMyLANZA_COHETES_ESPACIAL_02::AMyLANZA_COHETES_ESPACIAL_02()
{
	PrimaryActorTick.bCanEverTick = true;

	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/ASSETS/TORRETAS/Mesh_Torretas/Torreta01/TORRETA01.TORRETA01'"));
...
void AMyLANZA_COHETES_ESPACIAL_02::BeginPlay()
{
	Super::BeginPlay();
}

void AMyLANZA_COHETES_ESPACIAL_02::Tick(float DeltaTime)
{
...
void AMyLANZA_COHETES_ESPACIAL_02::Disparar_Cohetes() const
{
