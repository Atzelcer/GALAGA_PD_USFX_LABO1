...
ASHIP_LEVEL_04::ASHIP_LEVEL_04()
{
	// Conguracion de este actor en cada fotograma del juego 
	PrimaryActorTick.bCanEverTick = true;

	//|*| COMPONENTE MALLA DE LA NAVE |*|
	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/ASSETS/VARIOS_A/EnemyLevel5.EnemyLevel5'"));
	...
	//Asignando un nombre 
	Identificador_Nave = "Nave_Nivel_04";
}

void ASHIP_LEVEL_04::BeginPlay()
{
	Super::BeginPlay();
}

void ASHIP_LEVEL_04::Tick(float DeltaTime)
{
...
void ASHIP_LEVEL_04::Recibir_Danio()
{
	//|*| PARA HACER DANIO A LA NAVE  |*|
	Life -= Danio_Recibido;
}

void ASHIP_LEVEL_04::NotifyActorBeginOverlap(AActor* OtherActor)
{
...
void ASHIP_LEVEL_04::ComponentesUE_Sistema()
{
