...
AMyMINAS_ESPACIALES_03::AMyMINAS_ESPACIALES_03()
{
...
void AMyMINAS_ESPACIALES_03::BeginPlay()
{
	Super::BeginPlay();
}

void AMyMINAS_ESPACIALES_03::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void AMyMINAS_ESPACIALES_03::NotifyActorBeginOverlap(AActor* OtherActor)
{
    ...
    GetWorld()->GetTimerManager().SetTimer(TimerHandle, [this, ExplosionRadius]() {
        ...
        for (AActor* Actor : ActorsToDestroy)
        {
            ...
            AP_BU_MASTER_SHIP_CONS_02* EnemyShip = Cast<AP_BU_MASTER_SHIP_CONS_02>(Actor);
...
void AMyMINAS_ESPACIALES_03::Componentes_Explosion()
{
